...
public class AuthenticationActivity extends BaseActivity  implements AdapterView.OnItemSelectedListener {
     ...
     * polygonType is different from the previously selected polygonType or if
     * there was no selected item.</p>
     *
     * Implementers can call getItemAtPosition(polygonType) if they need to access the
     * data associated with the selected item.
     *
     * @param parent The AdapterView where the selection happened
     * @param view The view within the AdapterView that was clicked
     * @param position The polygonType of the view in the adapter
