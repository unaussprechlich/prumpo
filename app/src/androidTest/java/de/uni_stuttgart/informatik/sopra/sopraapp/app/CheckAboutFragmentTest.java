...
public class CheckAboutFragmentTest {
    ...
    public void settingsTest() {
        ...
        ViewInteraction cardView = onView(
                allOf(withId(R.id.about_frag_container_contacts),
                        childAtPosition(
                                allOf(withId(R.id.content_main_fragment_about),
                                        childAtPosition(
                                                withId(R.id.content_main_frame),
                                                0)),
                                1),
                        isDisplayed()));
        ...
        ViewInteraction cardView2 = onView(
                allOf(withId(R.id.about_frag_container_licence),
                        childAtPosition(
                                allOf(withId(R.id.content_main_fragment_about),
                                        childAtPosition(
                                                withId(R.id.content_main_frame),
