...
public class testUserWelcomeScreen {
    ...
    @Test
    public void testUserWelcomeScreen() {
        ...
        ViewInteraction textView = onView(
                allOf(withText("Willkommen"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Willkommen")));

        ViewInteraction imageView = onView(
                allOf(withId(R.id.logo_image),
                        childAtPosition(
                                childAtPosition(
