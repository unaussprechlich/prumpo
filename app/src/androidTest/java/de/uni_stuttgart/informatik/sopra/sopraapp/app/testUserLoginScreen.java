...
public class testUserLoginScreen {
    ...
    @Test
    public void testUserLoginScreen() {
                ...
                allOf(withId(R.id.su_email),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText3.perform(scrollTo(), replaceText("elias.mueller@mailbox.org"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.email),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatAutoCompleteTextView.perform(scrollTo(), replaceText("elias.mueller@mailbox.org"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withText("Karte"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView.check(matches(withText("Karte")));
